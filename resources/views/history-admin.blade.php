...
<div class="flex justify-center items-center min-h-screen bg-dots-darker bg-center bg-white-100 dark:bg-dots-lighter dark:bg-white-900">
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <div class="grid mb-16 mt-8">
            <h1 class="fw-bold text-2xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-3xl 2xl:text-3xl text-center mb-3 mt-20" style="color:black; font-family: 'Monsterrat', sans-serif;">Classification History - Admin</h1>
            @if ($images)
